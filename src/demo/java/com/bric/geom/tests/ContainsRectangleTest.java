...
public class ContainsRectangleTest extends Test {
	...
	public static boolean runGraphicalContainsTest(Shape shape,Point2D p) {
		...
		RectangularTransform transform = new RectangularTransform(
			new Rectangle2D.Double(p.getX(), p.getY(), 1, 1),
	...
	protected boolean runCase(int caseIndex) {
		...
		for(int a = 0; a<1000; a++) {
			contains = shape.contains(point.getX(), point.getY(), 1, 1);
		}
