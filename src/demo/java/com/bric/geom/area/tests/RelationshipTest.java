...
import com.bric.geom.area.tests.IntersectionsTest.MachineErrorException;
...
public class RelationshipTest extends BasicTestElement {
	...
	public void doTest() {
		...
		Hashtable<Object, Object> intersections = new Hashtable<Object, Object>();
		System.out.println("Beginning Intersections Accuracy Tests...");
		for(int a = 0; a<testCount; a++) {
			if(a%5==0)
				System.out.println("lhs = "+a);
			...
			for(int b = 0; b<testCount; b++) {
				...
				if(!passed) {					
					...
					System.out.println("failed.  lhs = "+a+", rhs = "+b+", rel = "+rel+", intersects = "+intersects+", ctr = "+ctr+", bounds = "+r);
					failures++;
					ctr++;
