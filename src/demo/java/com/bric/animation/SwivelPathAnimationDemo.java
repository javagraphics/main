...
import com.bric.animation.SwivelPathAnimation.Highlight;
import com.bric.awt.BufferedImagePaintable;
import com.bric.awt.EmptyPaintable;
import com.bric.awt.Paintable;
import com.bric.awt.TextBoxPaintable;
import com.bric.awt.TextClusterPaintable;
...
public class SwivelPathAnimationDemo extends BricApplet {
	private static final long serialVersionUID = 1L;

	private static boolean IS_APPLICATION = false;
	...
	public static void main(String[] args) {
		...
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				JFrame frame = new JFrame("Swivel Path Animation Demo");
				frame.getContentPane().add(new SwivelPathAnimationDemo());
	...
	class OverviewPanel extends JComponent {
		...
		AffineTransform getTransform() {
			...
			Dimension scaledSize = Scaling.scaleDimensionsProportionally(paintableSize, mySize);
		...
		protected void paintComponent(Graphics g0) {
			...
			for(int a = 0; a<highlights.size(); a++) {
				...
				if(h==indicatedHighlight) {
					...
					Dimension newSize = Scaling.scaleDimensionsProportionally(new Dimension( (int)(textBounds.getWidth()+1), (int)(textBounds.getHeight()+1) ), 
	...
	class PreviewPanel extends BufferedAnimationPanel {
		...
		PreviewPanel() {
			...
			backgroundPatternImage = ImageLoader.createImage( SwivelPathAnimationDemo.class.getResource("resources/Plimp_by_mickleness.png") );
		}
	...
	List<Highlight> highlights = new Vector<Highlight>();
	Shape path;
	...
	public SwivelPathAnimationDemo() {
		...
		help = new JFancyBox(this, helpText);
	}
