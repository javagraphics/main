...
import com.bric.image.BasicImageContext_v12.VariableWidthFunction.LineSegmentIntersectionException;
import com.bric.math.MathG;

/** This is a simple Java implementation of image transformations.
 * <p>This v12 draft helps eliminate iterating over irrelevant pixels.
 * @see com.bric.image.BasicImageContextDemo
 */
public class BasicImageContext_v12 extends ImageContext {
	 ...
	 */
	public BasicImageContext_v12(BufferedImage bi) {
		int type = bi.getType();
