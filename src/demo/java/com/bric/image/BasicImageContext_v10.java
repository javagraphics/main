 ...
 * <p>This v10 draft reduces the number of shift-right operations: this
 * reduced the overall computation to 97%.
 * @see com.bric.image.BasicImageContextDemo
 */
public class BasicImageContext_v10 extends ImageContext {
	 ...
	 */
	public BasicImageContext_v10(BufferedImage bi) {
		int type = bi.getType();
