 ...
 * <p>This v4 draft refactors some bounds checking from an inner loop: this
 * (surprisingly) did not appear to improve the overall performance.
 * @see com.bric.image.BasicImageContextDemo
 */
public class BasicImageContext_v4 extends ImageContext {
	 ...
	 */
	public BasicImageContext_v4(BufferedImage bi) {
		int type = bi.getType();
