 ...
 * <p>This v6 draft reduces the frequency of array accesses: this
 * reduced the overall computation to 98%.
 * @see com.bric.image.BasicImageContextDemo
 */
public class BasicImageContext_v6 extends ImageContext {
	 ...
	 */
	public BasicImageContext_v6(BufferedImage bi) {
		int type = bi.getType();
