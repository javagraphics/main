 ...
 * <p>This v8 draft inlines calls to <code>Math.min()</code>: this
 * reduced the overall computation to 97%.
 * @see com.bric.image.BasicImageContextDemo
 */
public class BasicImageContext_v8 extends ImageContext {
	 ...
	 */
	public BasicImageContext_v8(BufferedImage bi) {
		int type = bi.getType();
