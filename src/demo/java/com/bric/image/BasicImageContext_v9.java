 ...
 * <p>This v9 draft reduces number of conversions between primitives: this
 * reduced the overall computation to 96%.
 * @see com.bric.image.BasicImageContextDemo
 */
public class BasicImageContext_v9 extends ImageContext {
	 ...
	 */
	public BasicImageContext_v9(BufferedImage bi) {
		int type = bi.getType();
