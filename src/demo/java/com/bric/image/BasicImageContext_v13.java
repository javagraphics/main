...
import com.bric.image.BasicImageContext_v13.VariableWidthFunction.LineSegmentIntersectionException;
import com.bric.math.MathG;

/** This is a simple Java implementation of image transformations.
 * <p>This v13 draft uses multithreaded tile rendering: this
 * reduced the overall computation to 31%.
 * @see com.bric.image.BasicImageContextDemo
 */
public class BasicImageContext_v13 extends ImageContext {
	 ...
	 */
	public BasicImageContext_v13(BufferedImage bi) {
		this(bi, 6);
	 ...
	 */
	public BasicImageContext_v13(BufferedImage bi,int numberOfThreads) {
		int type = bi.getType();
