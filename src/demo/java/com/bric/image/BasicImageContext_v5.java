 ...
 * <p>This v5 draft refactors an if clause out of an inner loop: this
 * reduced the overall computation to 98%.
 * @see com.bric.image.BasicImageContextDemo
 */
public class BasicImageContext_v5 extends ImageContext {
	 ...
	 */
	public BasicImageContext_v5(BufferedImage bi) {
		int type = bi.getType();
