 ...
 * @(#)HSBTest.java
 *
 * $Date: 2015-03-17 07:14:09 +0100 (Di, 17 Mär 2015) $
 *
...
public class HSBTest {
	...
	/** Clocks and outputs median times calling
	 * <code>filterQuickly</code> and <code>filterSlowly</code>.
     * @param args the application's arguments. (This is unused.)
	 */
	public static void main(String[] args) {
		BasicConsole console = BasicConsole.create("HSBTest", false, true, true);
