...
import com.bric.swing.FileCheckList;
import com.bric.util.SearchConstraints;

public class ClassCheckList extends FileCheckList {
	private static final long serialVersionUID = 1L;
	
	/** @return all the tokens in a String separated by white space and made lowercase. */
	...
	private static boolean isMainLine(String s) {
		...
		if(i!=-1) {
			...
			//s2 will now be something like "(String[] args)" or "(String args[])"
	...
	public ClassCheckList(File directory,boolean includeMainMethod) {
		super(directory, includeMainMethod ? includeMainFilter : excludeMainFilter, basicComparatorConstraints);
	}
