 ...
 * <br>
 * <p>
 * <pre>Point2D start = new Point2D.Float(0, 0);<br>	
...
public final class LinearGradientPaint extends MultipleGradientPaint {
	...
	public String toString() {
    	return "LinearGradientPaint[ start=("+start.getX()+", "+start.getY()+"), end=("+end.getX()+", "+end.getY()+"), colors="+toString(getColors())+", fractions="+toString(getFractions())+"]";
    }
    ...
    protected static String toString(Color c) {
