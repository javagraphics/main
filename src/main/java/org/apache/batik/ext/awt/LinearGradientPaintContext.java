...
final class LinearGradientPaintContext extends MultipleGradientPaintContext {
     ...
     * linearly.
     *
     * @param pixels the destination array to fill with pixel data
     * @param off the offset in the pixels array to begin writing data
     * @param x the x-coordinate in device space for which colors are generated
     * @param y the y-coordinate in device space for which colors are generated
     * @param w The width in device space for which colors are generated
     * @param h The height in device space for which colors are generated
     *
     */
    @Override
