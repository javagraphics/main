 ...
 * @(#)AreaX.java
 *
 * $Date: 2015-09-13 20:51:33 +0200 (So, 13 Sep 2015) $
 *
 ...
 */
// This file is originally based on java.awt.geom.Area (c) 2006 by
...
import com.bric.geom.area.AreaXBody;
import com.bric.geom.area.CrossingsX;
import com.bric.geom.area.CurveX;

/** This class is a direct branch from the <code>java.awt.geom.Area</code>.
 * <p>
 * An <code>AreaX</code> object stores and manipulates a
 * resolution-independent description of an enclosed area of
 * 2-dimensional space.
 * <code>AreaX</code> objects can be transformed and can perform
 * various Constructive Area Geometry (CAG) operations when combined
 * with other <code>AreaX</code> objects.
 ...
 * operations.
 * <p>
 * The <code>AreaX</code> class implements the <code>Shape</code>
 * interface and provides full support for all of its hit-testing
 * and path iteration facilities, but an <code>AreaX</code> is more
 * specific than a generalized path in a number of ways:
 * <ul>
 * <li>Only closed paths and sub-paths are stored.
 *     <code>AreaX</code> objects constructed from unclosed paths
 ...
 *     <code>AreaX</code> resembles the path from which it was
 ...
 * the <code>AreaX</code> include:
 * <ul>
 * <li>Creating an <code>AreaX</code> from an unclosed (open)
 *     <code>Shape</code> results in a closed outline in the
 *     <code>AreaX</code> object.
 * <li>Creating an <code>AreaX</code> from a <code>Shape</code>
 *     which encloses no area (even when "closed") produces an
 *     empty <code>AreaX</code>.  A common example of this issue
 *     is that producing an <code>AreaX</code> from a line will
 *     be empty since the line encloses no area.  An empty
 *     <code>AreaX</code> will iterate no geometry in its
 ...
 * <li>An <code>AreaX</code> may take more path segments to
 *     describe the same geometry even when the original
 *     outline is simple and obvious.  The analysis that the
 *     <code>AreaX</code> class must perform on the path may
 *     not reflect the same concepts of "simple and obvious"
 *     as a human being perceives.
 * </ul>
 * 
 * <p>What is stated above is directly copied from the <code>java.awt.geom.Area</code>
 * javadocs.  Below are notes specifically related to the <code>AreaX</code> class:
 * <p>The AreaX class is intended to achieve exactly the same 
 * visual results as the Area class.  However several possible
 * optimizations have been carefully implemented to reach those
 * results faster.
 * <p>The most customizable change is the implementation of
 * the <code>AreaXRules</code> object.  Developers are encouraged to
 * subclass this object and experiment with it.  (And if they
 * make improvements: email them to me to include in this project!)
 * <p>Each <code>AreaX</code> object has a reference to a rules
 * object that can be changed by calling: <code>myArea.setRules()</code>.
 * However you can also change the <i>default</i> rules for all
 * future <code>AreaX</code> objects by calling:
 * <code>UIManager.put("AreaX.rules", myRules)</code>.
...
public class AreaX implements  Shape, Cloneable {
	...
	private static Hashtable<String, AreaXRules> rulesTable = new Hashtable<String, AreaXRules>();
	...
	private static AreaXRules getDefaultRules() {
		...
		if(className==null) className = "com.bric.geom.BoundsRules";
	...
	/**
	 * The <code>AreaX</code> class creates an area geometry from the
	 ...
	 * <p>If this is an <code>AreaX</code>, then this constructor forces 
	 ...
	 * <code>AreaX</code>.  It should not be necessary for
	 * other objects to need to call this method, except to 
	 * manager the time/cost of execution.
	 */
	...
	/** This returns the <code>AreaXBody</code> that currently
	 * expressed the data in this <code>AreaX</code>.
	 * This object will constantly be replaced as new operations
	 * are performed.
	 * <p>This forces any pending operations to be performed.
	 */
	...
	/**
	 * Adds the shape of the specified <code>Shape</code> to the
	 * shape of this <code>AreaX</code>.
	 * The resulting shape of this <code>AreaX</code> will include
	 * the union of both shapes, or all areas that were contained
	 * in either this or the specified <code>AreaX</code>.
	 * <pre>
	 *     // Example:
	 ...
	 *     ##                                 ##     ##            ##
	 * </pre>
	 * <p>This call does not immediately execute.  It adds this operation
	 * to a queue of operations that are processed as required.
	 * 
	 * @param   rhs  the <code>Shape</code> to be added to the
	 *          current shape
	 ...
	 * 
	 * @param shape 
	 * @return true whether the argument is completely contained inside this shape.
	 */
	 ...
	 * @return true whether the argument (when transformed) is completely contained inside this shape.
	 */
	 ...
	 * 
	 * @param shape 
	 * @return true whether the argument (when transformed) intersects this shape.
	 */
	 ...
	 * @return one of the 4 relationship constants: RELATIONSHIP_LHS_CONTAINS, RELATIONSHIP_RHS_CONTAINS,
	 * RELATIONSHIP_NONE, or RELATIONSHIP_COMPLEX.
	 */
	...
	/**
	 * Adds the shape of the specified <code>AreaX</code> to the
	 * shape of this <code>AreaX</code>.
	 * The resulting shape of this <code>AreaX</code> will include
	 * the union of both shapes, or all areas that were contained
	 * in either this or the specified <code>AreaX</code>.
	 ...
	 *     ##                                 ##     ##            ##
	 * </pre>
	 * <p>This call immediately executes.  It executes any pending
	 * operations first, and then executes this add.
	 * 
	 * @param   rhs  the <code>AreaX</code> to be added to the
	 *          current shape
	 * @throws NullPointerException if <code>rhs</code> is null
	 */
	...
	/**
	 * Subtracts the shape of the specified <code>Shape</code> from the
	 * shape of this <code>AreaX</code>.
	 * The resulting shape of this <code>AreaX</code> will include
	 * areas that were contained only in this <code>AreaX</code>
	 ...
	 * <p>This call does not immediately execute.  It adds this operation
	 * to a queue of operations that are processed as required.
	 * @param   rhs  the <code>AreaX</code> to be subtracted from the
	 *		current shape
	 * @throws NullPointerException if <code>rhs</code> is null
	 */
	...
	/**
	 * Subtracts the shape of the specified <code>AreaX</code> from the
	 * shape of this <code>AreaX</code>.
	 * The resulting shape of this <code>AreaX</code> will include
	 * areas that were contained only in this <code>AreaX</code>
	 * and not in the specified <code>AreaX</code>.
	...
	/**
	 * Sets the shape of this <code>AreaX</code> to the intersection of
	 * its current shape and the shape of the specified <code>Shape</code>.
	 * The resulting shape of this <code>AreaX</code> will include
	 * only areas that were contained in both this <code>AreaX</code>
	 * and also in the specified <code>AreaX</code>.
	 * <pre>
	 *     // Example:
	 *     Area a1 = new Area([triangle 0,0 =&gt; 8,0 =&gt; 0,8]);
	 *     Area a2 = new Area([triangle 0,0 =&gt; 8,0 =&gt; 8,8]);
	...
	/**
	 * Sets the shape of this <code>AreaX</code> to the intersection of
	 * its current shape and the shape of the specified <code>AreaX</code>.
	 * The resulting shape of this <code>AreaX</code> will include
	 * only areas that were contained in both this <code>AreaX</code>
	 * and also in the specified <code>AreaX</code>.
	 * <pre>
	...
	/**
	 * Sets the shape of this <code>AreaX</code> to be the combined area
	 * of its current shape and the shape of the specified <code>Shape</code>,
	 * minus their intersection.
	 * The resulting shape of this <code>AreaX</code> will include
	 * only areas that were contained in either this <code>AreaX</code>
	...
	/**
	 * Sets the shape of this <code>AreaX</code> to be the combined area
	 * of its current shape and the shape of the specified <code>AreaX</code>,
	 * minus their intersection.
	 * The resulting shape of this <code>AreaX</code> will include
	 * only areas that were contained in either this <code>AreaX</code>
	 * or in the specified <code>AreaX</code>, but not in both.
	...
	/**
	 * Removes all of the geometry from this <code>AreaX</code> and
	 ...
	 * <p>This forces any pending operations to be performed.
	 * @return    <code>true</code> if this <code>AreaX</code> object
	...
	/**
	 * Tests whether this <code>AreaX</code> consists entirely of
	 * straight edged polygonal geometry.
	 * <p>This forces any pending operations to be performed.
	 * @return    <code>true</code> if the geometry of this
	 * <code>AreaX</code> consists entirely of line segments;
	 ...
	 * <p>This forces any pending operations to be performed.
	 * @return    <code>true</code> if the geometry of this
	 * <code>AreaX</code> is rectangular in shape; <code>false</code>
	 * otherwise.
	 */
	public synchronized boolean isRectangular() {
		...
		if (c1.getXTop() != c1.getXBot()
				|| c2.getXTop() != c2.getXBot()) {
			return false;
		}
		if (c1.getYTop() != c2.getYTop()
				|| c1.getYBot() != c2.getYBot()) {
//			One might be able to prove that this is impossible...
	...
	/**
	 * Tests whether this <code>AreaX</code> is comprised of a single
	 ...
	 * <p>This forces any pending operations to be performed.
	 * @return    <code>true</code> if the <code>AreaX</code> is comprised
	 ...
	 * completely encloses this <code>AreaX</code>.
	 * <p>
	...
	/**
	 * Tests whether the geometries of the two <code>AreaX</code> objects
	 * are equal.
	...
	/**
	 * Creates a new <code>AreaX</code> object that contains the same
	 * geometry as this <code>AreaX</code> transformed by the specified
	 * <code>AffineTransform</code>.  This <code>AreaX</code> object
	 * is unchanged.
	 * <p>This forces any pending operations to be performed.
	...
	public synchronized boolean contains(double x, double y, double w, double h) {
		...
		CrossingsX c = CrossingsX.findCrossings(body, x, y, x + w, y
				+ h);
	...
	public synchronized boolean intersects(Rectangle2D r) {
		return intersects(r.getX(), r.getY(), r.getWidth(), r
				.getHeight());
	}

	/**
	 * Creates a {@link PathIterator} for the outline of this
	 * <code>AreaX</code> object.  This <code>AreaX</code> object is unchanged.
	 * <p>This forces any pending operations to be performed.
	 * @param at an optional <code>AffineTransform</code> to be applied to
	 * the coordinates as they are returned in the iteration, or
	 * <code>null</code> if untransformed coordinates are desired
	 * @return    the <code>PathIterator</code> object that returns the
	 *		geometry of the outline of this <code>AreaX</code>, one
	 *		segment at a time.
	 */
	 ...
	 * this <code>AreaX</code> object.  Only uncurved path segments
	 * represented by the SEG_MOVETO, SEG_LINETO, and SEG_CLOSE point
	 * types are returned by the iterator.  This <code>AreaX</code>
	 * object is unchanged.
	 ...
	 * @return    the <code>PathIterator</code> object that returns the
	 * geometry of the outline of this <code>AreaX</code>, one segment
	 * at a time.
	 */
	public synchronized PathIterator getPathIterator(AffineTransform at,
			double flatness) {
