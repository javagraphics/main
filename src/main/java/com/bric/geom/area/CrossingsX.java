 ...
 */
// This file is originally based on sun.awt.geom.Crossings (c) 2003 by
...
public abstract class CrossingsX {
	...
	public static CrossingsX findCrossings(AreaXBody body,
	...
	public static CrossingsX findCrossings(PathIterator pi,
			double xlo, double ylo,
			double xhi, double yhi)
	{
		CrossingsX cross;
