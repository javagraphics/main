...
import com.bric.plaf.OpenLocationPaneUI;
...
public class OpenLocationPane extends LocationPane {
	...
	public void updateUI() {
    	if(UIManager.getDefaults().get(uiClassID)==null) {
    		UIManager.getDefaults().put(uiClassID, "com.bric.plaf.AquaOpenLocationPaneUI");
    		//UIManager.getDefaults().put(uiClassID, "com.bric.plaf.XPOpenLocationPaneUI");
    	}
    	try {
