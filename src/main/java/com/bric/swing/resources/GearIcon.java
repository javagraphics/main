...
@ResourceSample( 
		sample= { 
		"new com.bric.swing.resources.GearIcon( 12, java.awt.Color.darkGray)",
		"new com.bric.swing.resources.GearIcon( 24, java.awt.Color.darkGray)"},
		names = { "12x12", "24x24" } )
public class GearIcon implements Icon {
	...
	public GearIcon(int diameter,Color color) {
		...
		gear.append(new Ellipse2D.Float(center-r3,center-r3,2*r3,2*r3).getPathIterator(null), false);
		gear.closePath();
		...
		gear.transform(AffineTransform.getRotateInstance(2*Math.PI/32, center, center));
	}
