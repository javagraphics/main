...
public class CheckIcon implements Icon {
	 ...
	 * @param width the width (in pixels) of this icon.
	 * @param height the height (in pixels) of this icon.
	 * @param c the optional color of this icon. If null: then a dark gray is used by default.
	 */
	...
	public void paintIcon(Component c, Graphics g, int x, int y) {
		...
		g2.transform( TransformUtils.createAffineTransform(abstractBounds, realBounds) );
		g2.fill(checkShape);
		g2.dispose();
	}
