...
public abstract class RecentMenu extends JMenu {
	...
	public static class Preference extends RecentMenu {
		...
		private static String FILE_ENTRY = RecentMenu.class.getName()+"#file-entry";
		
		protected Preferences prefs;

		/**
		 * 
		 * @param includeClearItem true if this menu should include a "Clear" menu item.
		 * @param t this is used to construct a Preferences object to store and retrieve the list of files.
		 */
	...
	/** Clear this menu and replace its UI contents with the current
	 * contents of <code>getFiles()</code>.
	 */
	...
	/** Replace the files this menu represents.
	 * This method automatically invokes <code>refresh()</code>, so the UI
	 * is updated.
	 * 
	 * @param files a list of files (in the order they should be shown)
	 * @return true if this resulted in a change, false if it was a redundant operation.
	 */
	 ...
	 * subclass-dependent).
	 * 
	 * @param files an ordered list of files to store.
	 * @return true if this resulted in a change, false if it was a redundant operation.
	 */
	 ...
	 * touched file).
	 * 
	 * @param file the file to add to the recently used file list.
