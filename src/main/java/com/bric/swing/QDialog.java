...
public class QDialog extends JDialog 
{
    ...
    public static JComponent createContentPanel(String boldText,String plainText,JComponent innerComponent,boolean selectable) {
    	...
    	if(boldText!=null) {
	    	...
	    	boldTextArea.setFont(UIManager.getFont("OptionPane.messageFont"));
	    	boldTextArea.setFont(boldTextArea.getFont().deriveFont(Font.BOLD));
   		...
   		if(plainText!=null) {
	    	...
	    	plainTextArea.setFont(UIManager.getFont("OptionPane.messageFont"));
	...
	public static ResourceBundle strings = ResourceBundle.getBundle("com.bric.swing.resources.QDialog");
