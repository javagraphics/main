...
import com.bric.graphics.BaselineGraphics2D;
...
public class GridBagDebugPanel extends JPanel {
	...
	Vector<Component> indicatedComponents = new Vector<Component>();
	...
	private static Hashtable<String, Field> fields = new Hashtable<String, Field>();
