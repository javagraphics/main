 ...
 * <p><img src="https://javagraphics.java.net/resources/filledbuttonui/XPButtonUI.png" alt="XPButtonUI Screenshot">
	...
	public void paintBackground(Graphics2D g, ButtonInfo info) {
		...
		if(info.button.getModel().isPressed() ||
			...
			if(info.button.isContentAreaFilled()) { 
				...
				if((showSeparators) || (vPos==POS_ONLY || vPos==POS_BOTTOM)) {
					g.setColor(hShadow1);
