 ...
 * buttons in GarageBand.
 * <p><img src="https://javagraphics.java.net/resources/filledbuttonui/PlasticButtonUI.png" alt="PlasticButtonUI Screenshot">
 * <p>They are translucent,
	...
	public void paintBackground(Graphics2D g, ButtonInfo info) {
		...
		if(info.button.isContentAreaFilled()) {
			...
			synchronized(shadow) {
				...
				shadow.lineTo(info.fillBounds.x+j,
						info.fillBounds.y+info.fillBounds.height);
				shadow.closePath();
