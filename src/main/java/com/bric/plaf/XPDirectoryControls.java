...
public class XPDirectoryControls extends JPanel {
	...
	protected static final ImageIcon BACK_ICON = new ImageIcon(XPDirectoryControls.class.getResource("resources/xp_back.png"));
	protected static final ImageIcon UP_ICON = new ImageIcon(XPDirectoryControls.class.getResource("resources/xp_up_directory.png"));
	protected static final ImageIcon NEW_FOLDER_ICON = new ImageIcon(XPDirectoryControls.class.getResource("resources/xp_new_folder.png"));
	protected static final ImageIcon LIST_ICON = new ImageIcon(XPDirectoryControls.class.getResource("resources/xp_view.png"));
