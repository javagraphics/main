...
import com.bric.swing.QOptionPane;
...
public class BasicQOptionPaneUI extends QOptionPaneUI {
	...
	private static ResourceBundle getDefaultResourceBundle() {
		...
		try {
			return ResourceBundle.getBundle("com/bric/plaf/resources/"+sb.toString());	
		} catch(Throwable t) {
			return ResourceBundle.getBundle("com/bric/plaf/resources/QOptionPaneUI_Windows7");
		}
	}
	...
	private static Hashtable<String, Object> typeTable = new Hashtable<String, Object>();
	{
