/*
 * @(#)ScalingJPEGDemo.java
 *
 * $Date: 2015-03-17 22:17:03 +0100 (Di, 17 Mär 2015) $
 *
...
public class ScalingJPEGDemo {
	...
	public static URL getImageURL() {
		...
		return ScalingJPEGDemo.class.getResource("resources/bridge3.jpg");
	}
	...
	public static void main(String[] args) {
		...
		try {
			...
			out.println("\nhttps://java.net/svn/javagraphics~svn/trunk/tests/com/bric/image/resources/bridge3.jpg");
	...
	private static List<ImageReader> getIOReaderList() {
		...
		final Vector<ImageReader> ioReaderList = new Vector<ImageReader>();
