 ...
 * @(#)JPEGMetaData.java
 *
 * $Date: 2015-03-14 00:39:03 +0100 (Sa, 14 Mär 2015) $
 *
...
public class JPEGMetaData {
	...
	/** Extract a thumbnail from a JPEG image, if possible.
	 * This may return null if no thumbnail can be found.
	 * @throws IOException if an IO problem occurs.
	 */
	 ...
	 * @throws IOException
	 */
	public JPEGMetaData(InputStream in,boolean fetchThumbnail) throws IOException {
		init(in, fetchThumbnail);
	}
	...
	/** Returns the map of properties found in this JPEG.
	 * This will not be null, but it may be empty.
	 * <p>Note this does not return a clone of this map, so
	 * if you change the contents of this map then this
	 * metadata object is permanently altered.
	 */
	...
	/** Returns the thumbnail if one exists.  This may return
	 * null.
	 */
