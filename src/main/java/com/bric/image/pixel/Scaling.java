...
public class Scaling {
	 ...
	 */
	public static Dimension scaleDimensionsProportionally(Dimension originalSize,Dimension maxSize) {
	 ...
	 * @return dimensions that are <code>maxSize</code> or smaller.
	 */
	public static Dimension2D scaleDimensionsProportionally(Dimension2D originalSize,Dimension2D maxSize) {
