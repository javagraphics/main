 ...
 * @(#)ScreenCapture.java
 *
 * $Date: 2014-05-04 17:30:35 +0200 (So, 04 Mai 2014) $
 *
...
import com.bric.awt.MouseTracker;
...
public abstract class ScreenCapture {
	...
	private static class ScreenCaptureAnimation implements ResettableAnimationReader {
		...
		public ScreenCaptureAnimation(Rectangle captureBounds,Vector<Record> snapshots,boolean loop,double playbackRate) {
			this.list = snapshots;
		...
		class PaintedCursor {
			BufferedImage cursorImage = ImageLoader.createImage(ScreenCapture.class.getResource("resources/cursor.png"));
			BufferedImage cursorClickedImage = ImageLoader.createImage(ScreenCapture.class.getResource("resources/cursorClicked.png"));
			int hotX = 11;
			int hotY = 9;
	...
	Vector<Record> snapshots = new Vector<Record>();
	...
	public ScreenCapture() {
		...
		Toolkit.getDefaultToolkit().addAWTEventListener(new AWTEventListener() {
			Hashtable<Component, Rectangle> table = new Hashtable<Component, Rectangle>();
